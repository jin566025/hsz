			...
			<div className="item">
				<div className="item-content flex-box">
					...
					<div className="item-content-right flex1">
						<div className="item-content-name flex-box" onClick={()=>{this.props.checkChild(this.props.items.rcProChildPk,this.props.items.amount,this.props.index)}}>
							<p className="item-name  flex1">{this.props.items.childNo} {this.props.items.rcProChildName} </p>
							<div style={ this.props.items.check ? {backgroundColor: '#CE3B27'} : { backgroundColor: '#999'} }  className={`item-check  ${this.props.items.statNm==="未完成" ? 'show' : 'hide'}`} ></div>
						...
						<p className="item-msg">{this.props.items.proNm} {this.props.items.cityNm} { this.props.items.disNm } {this.props.items.school}</p>
